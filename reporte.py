...
df = pd.read_excel(base_dir+"/data/Carex COL Reporte Vendedor 1.xlsx",sheet_name='BD')

print(df['Valor Total USD'].tail(10))
...
df_BV = pd.read_excel(base_dir+"/data/Carex COL Reporte Vendedor 1.xlsx",sheet_name='Budget x Vendedor')
df_BV['Valor Total USD'] = df_BV['Valor Total USD']
